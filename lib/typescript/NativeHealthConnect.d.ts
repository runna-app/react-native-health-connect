...
export interface Spec extends TurboModule {
    ...
    requestPermission(permissions: (Permission | WriteExerciseRoutePermission | ReadHealthDataHistoryPermission)[]): Promise<(Permission | WriteExerciseRoutePermission)[]>;
    requestExerciseRoute(recordId: string): Promise<ExerciseRoute>;
    getGrantedPermissions(): Promise<(Permission | WriteExerciseRoutePermission)[]>;
